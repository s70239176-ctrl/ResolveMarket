...
const emptyForm = { question: "", description: "", sourceUrl: "", sourceName: "", yesLabel: "Yes", noLabel: "No", deadline: "" };
...
export default function AdminPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try { const deadline = Math.floor(new Date(form.deadline).getTime() / 1000); await createMarket(wallet.address, [form.question, form.description, form.sourceUrl, form.sourceName, form.yesLabel, form.noLabel, deadline]); setStatus("finalized"); setForm(emptyForm); await reload(); }
